          ...
          * @param {string} cidrStr - The IPv4 subnet expressed
           *                 in CIDR format.
            * @param {callback} callback - A callback function.
             * @return {object} - An object with  IPv4 address and
                                                                 ...
                                                                 // If the passed CIDR is valid, call the object's toArray() method.
                                                                     // Notice the destructering assignment syntax to get the value of the first array's element.
                                                                         [firstIpAddress] = cidr.toArray(options);
                                                                             ...
                                                                             finalRes.ipv4=firstIpAddress;
                                                                               if(firstIpAddress!=null)
                                                                                 finalRes.ipv6=getIpv4MappedIpv6Address(firstIpAddress);
                                                                                   else
                                                                                     finalRes.ipv6=null;


                                                                                     //console.log(`finalRes is: {"ipv4":"${finalRes.ipv4}","ipv6":"${finalRes.ipv6}"`);
                                                                                       // Call the passed callback function.
                                                                                         // Node.js convention is to pass error data as the first argument to a callback.
                                                                                           // The IAP convention is to pass returned data as the first argument and error
                                                                                             // data as the second argument to the callback function.

                                                                                               return callback(finalRes, callbackError);
                                                                                               }
